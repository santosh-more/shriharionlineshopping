...
var DynamicFormComponent = /** @class */ (function () {
    ...
    DynamicFormComponent.prototype.createItem = function () {
    ...
    DynamicFormComponent.prototype.addItem = function () {
        this.items = this.orderForm.get('items');
        this.items.push(this.createItem());
    };
    DynamicFormComponent.prototype.removeItem = function (index) {
...
var PageNotFoundComponent = /** @class */ (function () {
    ...
    PageNotFoundComponent.prototype.gotoLogin = function () {
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.createItem = function () {
        return this.formBuilder.group({
            name: '',
            description: '',
            price: ''
    ...
    DashboardComponent.prototype.removeItem = function (index) {
        this.items.removeAt(index);
    };
...
var UploadProductComponent = /** @class */ (function () {
    function UploadProductComponent(formBuilder) {
        this.formBuilder = formBuilder;
    ...
    UploadProductComponent.prototype.ngOnInit = function () {
    };
    UploadProductComponent.prototype.uploadProduct = function () {
    ...
    UploadProductComponent.prototype.showPreview = function () {
        this.isPreview = true;
    };
    UploadProductComponent.prototype.removePreview = function () {
        this.isPreview = false;
    };
    UploadProductComponent.prototype.uploadImage = function (files) {
        var _this = this;
        if (files.length === 0) {
            return;
        }
    ...
    UploadProductComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.decideRoute = function () {
        if (sessionStorage.getItem('isLoggedIn') === 'true') {
            this.router.navigate(['user/upload-product']);
        }
        else {
